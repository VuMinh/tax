...
use app\models\base\Baocaokiemtra;
...
$this->title = "Báo cáo chi tiết KT mẫu mới";
...
<div class="bao-cao-kiem-tra-export-excel">
    ...
    <div class="bao-cao-kiem-tra-form">
        ...
        <?php $form = ActiveForm::begin([
            'action' => ['bao-cao-kiem-tra/export-excel-bao-cao-kiem-tra-chi-tiet-mau-moi'],
        ...
        <div class="row">
            <div class="col-md-6"><?= $form->field($model, 'truongDoan6')->widget(Select2::className(), [
                    'data' => $truongDoanData,
            ...
            <div class="col-md-6"><?= $form->field($model, 'doiKiemTra8')->widget(Select2::className(), [
                    'data' => $doiKiemTraData,
